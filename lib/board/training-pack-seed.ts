  ...
  return [
    {
      ...
      why_now: `O caso so deve ir ao board quando a decisao central de ${pack.caseTitle} estiver separada das iniciativas acessorias.`,
      evidence: pack.companySeed.knownUnknowns.slice(0, 2).join(', '),
      evidence_gap: 'Definir fonte, indicador, responsavel e data de revisao para cada lacuna critica.',
      decision_question: `O board deve aprovar, adiar ou pedir mais dados para ${pack.caseTitle}?`,
    },
    {
      title: 'Definir gates financeiros e operacionais',
      priority: 'alta',
      rationale: 'Transforma ambicao em condicoes de aprovacao, pausa ou escala.',
      why_now: 'Gates impedem que o plano vire uma lista ampla de iniciativas sem criterio de parada.',
      evidence: 'Riscos, oportunidades e restricoes operacionais mapeadas no pack.',
      evidence_gap: 'DRE/P&L, OCF, unit economics, capacidade do time e risco de concentracao.',
      decision_question: 'Quais gates precisam ser cumpridos antes de escalar o plano?',
    },
    {
      title: 'Registrar decisao, responsavel e cadencia',
      priority: 'media',
      rationale: 'Evita que a recomendacao se perca depois da reuniao.',
      why_now: 'Sem dono e revisao, a decisao nao vira governanca operacional.',
      evidence: 'Advisor reviews convergem para necessidade de responsabilizacao e follow-up.',
      evidence_gap: 'Responsavel nominal, prazo, indicador lider e criterio de escalacao.',
      decision_question: 'Quem responde pela decisao e quando o board revisa resultado?',
    },
  ]
}
  ...
  const plan = await must<any>('insert business plan', service
    ...
    .insert({
      ...
      workstreams: [
        {
          title: 'Evidencias',
          workstream: 'Evidencias minimas',
          owner: 'Board Brain',
          owner_suggestion: 'Board Brain',
          cadence: 'semanal',
          why_selected: `A decisao sobre ${pack.caseTitle} depende de separar fato, premissa e opiniao.`,
          evidence: pack.companySeed.knownUnknowns.join(', '),
          evidence_gap: 'Fonte, indicador, owner e data de revisao por lacuna.',
          decision_question: `O board tem evidencia suficiente para decidir ${pack.caseTitle}?`,
          proof_point: pack.companySeed.knownUnknowns.join(', '),
        },
        {
          title: 'Financeiro',
          workstream: 'Gates financeiros',
          owner: 'Finance Advisor',
          owner_suggestion: 'Finance Advisor',
          cadence: 'quinzenal',
          why_selected: 'Gates criam criterio de aprovacao, pausa ou escala.',
          evidence: 'Riscos financeiros e operacionais do pack.',
          evidence_gap: 'DRE/P&L, OCF, payback, runway e concentracao.',
          decision_question: 'Quais gates financeiros condicionam a aprovacao?',
          proof_point: 'DRE, OCF e payback minimo.',
        },
        {
          title: 'Execucao',
          workstream: 'Responsabilizacao e cadencia',
          owner: 'Operator Advisor',
          owner_suggestion: 'Operator Advisor',
          cadence: 'semanal',
          why_selected: 'A recomendacao precisa virar rotina de decisao, nao apenas ata.',
          evidence: 'Lacunas de responsavel, prazo e indicador lider.',
          evidence_gap: 'Owner, data de revisao e bloqueios por frente.',
          decision_question: 'Quem responde pela proxima prova de avanco?',
          proof_point: '100% das frentes com responsavel e checkpoint.',
        },
      ],
