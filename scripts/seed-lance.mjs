...
const priorities = [
  {
    ...
    why_now: 'Sem reconhecimento nomeado, o crescimento de alcance continua vulneravel a algoritmo, agregadores e baixa lembranca entre compradores jovens.',
    evidence: 'Plano Creative OS aponta gap de atribuicao de marca; Midia Kit mostra escala suficiente para testar brand lift com massa critica.',
    evidence_gap: 'Medir baseline de direct/branded search, awareness 18-32 e percepcao de media buyers 25-35 antes da campanha.',
    decision_question: 'O board aprova reposicionamento e campanha para tornar LANCE! a fonte nomeada do torcedor 18-32?',
  ...
  },
  {
    ...
    why_now: 'A empresa ja tem distribuicao e produtos de relacionamento; o risco e continuar monetizando audiencia anonima com pouco controle.',
    evidence: 'Midia Kit e fonte Socio LANCE! indicam app, CRM, newsletter, WhatsApp, push e beneficios como ativos proprietarios em formacao.',
    evidence_gap: 'Confirmar usuarios identificados, opt-in, D7/D30, churn, margem por plano e receita incremental por usuario.',
    decision_question: 'O board aprova priorizar app/CRM como eixo de audiencia propria, condicionado a gates de retencao e margem?',
  ...
  },
  {
    ...
    why_now: 'Antes de escalar pacotes premium, o board precisa separar volume comercial de receita recorrente, margem e risco de concentracao.',
    evidence: 'Materiais publicos mostram produtos e alcance; faltam DRE, P&L, OCF, margem por produto e concentracao por categoria.',
    evidence_gap: 'Criar DRE gerencial por produto/categoria, OCF, margem, ticket medio, recorrencia e concentracao de anunciantes.',
    decision_question: 'O board exige DRE gerencial e scorecard de receita antes de aprovar escala comercial?',
  ...
  },
  {
    ...
    why_now: 'A agenda combina marca, produto, editorial, social, CRM e comercial; sem ritual comum, a execucao vira soma de iniciativas.',
    evidence: 'Pre-work explicita app, newsletter, YouTube, comercial e previsibilidade como frentes simultaneas.',
    evidence_gap: 'Definir owner, KPI lider, bloqueios, data de revisao e criterio de trade-off por frente.',
    decision_question: 'O board aprova uma cadencia unica semanal para priorizar, remover bloqueios e revisar compromissos?',
  ...
  },
  {
    ...
    why_now: 'Crescer receita em categorias sensiveis sem apetite de risco explicito pode corroer confianca editorial e valor de marca.',
    evidence: 'O mix de branded content, creators, dados, betting e beneficios aparece como oportunidade comercial e risco de governanca.',
    evidence_gap: 'Formalizar apetite de risco, politica editorial-comercial, revisao juridica e criterios por categoria.',
    decision_question: 'O board aprova crescimento nessas categorias apenas com guardrails reputacionais, dados e compliance definidos?',
...
async function seedGovernanceChain(organization, company, user, sourceDocumentIds) {
  const diagnosis = [
    'LANCE! tem alcance e autoridade, mas o problema de board e converter audiencia anonima em escolha consciente, relacionamento proprietario e receita de qualidade.',
    'A decisao nao e fazer mais iniciativas; e escolher quais apostas merecem prioridade, sob quais evidencias financeiras/operacionais e com quais guardrails de marca, dados e reputacao.',
    'A confianca segue limitada ate fechar DRE/P&L, OCF, margem por produto e concentracao comercial.',
  ].join(' ')
  ...
  const businessPlan = await must('insert business plan', service
    ...
    .insert({
      ...
      workstreams: [
        {
          workstream: 'Break-news habit loop e atribuicao LANCE!',
          owner_suggestion: 'Marca + Editorial + Social',
          cadence: 'Semanal',
          why_selected: 'Resolve a lacuna entre alcance anonimo e escolha consciente pelo nome LANCE!.',
          evidence: 'Plano Creative OS prioriza match-day moments, atribuicao e lembranca 18-32.',
          evidence_gap: 'Baseline de brand search, awareness e comportamento por formato.',
          decision_question: 'Aprovar foco em atribuicao de marca antes de aumentar volume de formatos?',
          proof_point: 'Branded search, saves/shares, follows e match-day owned-channel share.',
        },
        {
          workstream: 'Jornalistas como produto de autoridade',
          owner_suggestion: 'Editorial + Produto + Social',
          cadence: 'Semanal',
          why_selected: 'Transforma memoria apurada e sourcing em ativo defensavel, nao apenas em conteudo commodity.',
          evidence: 'Intelligence Report aponta trinta anos de memoria e jornalistas como moat.',
          evidence_gap: 'Escolher 8-12 vozes, territorio editorial, formato e scorecard individual.',
          decision_question: 'Aprovar investimento em vozes individuais sem diluir a marca institucional?',
          proof_point: '8-12 vozes ativadas, seguidores combinados, explicadores e audio/video por reporter.',
        },
        {
          workstream: 'App, CRM e dados first-party',
          owner_suggestion: 'Produto + Dados',
          cadence: 'Semanal',
          why_selected: 'Converte distribuicao em relacionamento proprietario, segmentacao e receita mais governavel.',
          evidence: 'Midia Kit e Socio LANCE! indicam app, newsletter, WhatsApp, push e beneficios.',
          evidence_gap: 'Usuarios identificados, opt-in, retencao D7/D30, churn e margem por plano.',
          decision_question: 'Aprovar app/CRM como eixo estrategico condicionado a gates de retencao e receita?',
          proof_point: 'Usuarios identificados, D7/D30, opt-in e receita por usuario.',
        },
        {
          workstream: 'DRE gerencial e receita de qualidade',
          owner_suggestion: 'Financeiro + CRO',
          cadence: 'Mensal',
          why_selected: 'Sem visao financeira por linha, o board nao sabe quais produtos merecem escala.',
          evidence: 'Materiais publicos nao trazem DRE, OCF, margem ou concentracao comercial.',
          evidence_gap: 'DRE por produto/categoria, OCF, margem, recorrencia e concentracao de anunciantes.',
          decision_question: 'Exigir DRE gerencial antes de aprovar novos investimentos comerciais?',
          proof_point: 'DRE por linha, OCF, margem e concentracao.',
        },
        {
          workstream: 'Governanca editorial-comercial',
          owner_suggestion: 'Editorial + Juridico + Comercial',
          cadence: 'Mensal',
          why_selected: 'Protege confianca editorial enquanto abre receita em categorias sensiveis.',
          evidence: 'Oportunidades de creators, betting, branded content e dados elevam risco reputacional.',
          evidence_gap: 'Apetite de risco, politica por categoria, aprovacao juridica e revisao mensal.',
          decision_question: 'Aprovar monetizacao sensivel apenas com guardrails formalizados?',
          proof_point: 'Politica de categorias, branded content, creators, betting e dados.',
        },
      ],
      timeline: {
        next_13_weeks: [
